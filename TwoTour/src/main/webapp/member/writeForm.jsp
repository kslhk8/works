   			...
   			<div id="writeForm_inform_table">
   				...
   				<div id="table_id_wrap">
   					...
   					<div id="table_id_content">
   						<input type="text" id="id" name="id" placeholder="하나투어 아이디">
   						<div id="idDiv"></div>
   					</div>
   ...
   <div id="writeForm_terms_table">
   		...
   		<div id="table_terms_box">
   			<div id="table_box_content">
   				<div id="box1">
   				<input type="checkbox" id="accept1" name="accept1"><label> 하나투어 온라인 몰 통합 회원 약관 동의 (필수)</label>
   				</div>
   				<div id="box2">
   					<label>전문보기</label>
   				</div>
   		...
   		<div id="table_terms_guide">
   			<div id="guide_name">
   				<label>하나투어 온라인 몰 통합 회원 약관 동의</label>
   			</div>
   			<div id="guide_value">
   				<pre><textarea rows="7" cols="147"  id="content" name="content">
제1조 (목적)

이 통합약관은 하나투어 주식회사가 운영하는 A: 하나투어닷컴, B:하나티켓 등 인터넷쇼핑몰(이하 "회사"라 한다)에서 제공하는 인터넷관련 서비스(이하 "서비스"라 한다)를 하나의 ID 로 각 사이트에 가입하여 이용함에 있어 하나투어 및 하나투어서비스와 이용자의 권리 의무 및 책임사항을 규정함을 목적으로 합니다.

제2조(정의)
① "회사" 란 하나투어주식회사가 재화 또는 용역(이하 "재화등"이라 함)을 이용자에게 제공하기 위하여 컴퓨터등 정보통신 설비를 이용하여 재화등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 인터넷쇼핑몰을 운영하는 사업자의 의미로도 사용합니다
...
③ “회사”는 회원여부 확인 및 회원서비스의 원할한 수행 목적을 위해 필요한 경우 당사 상품 판매처인, 하나투어전문판매점 (도우미 대리점)에 제한적으로 최소한의 회원정보를 공유합니다. 이 사항에 대하여는 "회원"가입시 명시적인 고지와 동의 절차를 준행합니다.
④ "회사"는 신속하고 원활한 고객응대 및 효율적인 여행상담 진행을 위해 하나투어닷컴 콜센터 대리점 제도를 운영합니다. 이 사항에 대하여는 당사 [개인정보처리방침] 에 개인정보 취급위탁 항목으로 상세하게 안내드립니다.
